if (-not $args) {
    ...
    Write-Host 'github.com/Stefan-cloud-tech/win10' -ForegroundColor Green
    Write-Host
}

& {
    $psv = (Get-Host).Version.Major
    $troubleshoot = 'github.com/Stefan-cloud-tech/win10'
    ...
    $releaseHash = 'B36DCF65F2B1719C7C9FF11D61BC60AF4D35993A6B32ADD48E9740BF7C2E0BBA'
